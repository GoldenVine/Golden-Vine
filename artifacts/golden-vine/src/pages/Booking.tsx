...
export function Booking() {
  ...
  const policyItems = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>Jewellery that leaves the studio cannot be accepted as a return. This is for a number of reasons but primarily- health and safety. The reason for this is it negates our ability to guarantee it's remained unworn, new, and free from defect. At Golden Vine, every person getting pierced or buying jewellery here has the right to know their piece is brand new and flawless at point of purchase.</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>No Minimum</strong> for lobes ONLY. Although there are no specific age limits for piercing lobes on kids, we at Golden Vine are very particular with our process. For kids under the age of 10 we do an in-person consultation so not only can we run through the specifics with parent/legal guardian but also so we can gauge comfort level of everyone involved and to make sure you get the best experience possible with your child. Parental/legal guardian permission, accompaniment, and co-signing as well as Photo ID are necessary and adult must remain present throughout the procedure.</li>
