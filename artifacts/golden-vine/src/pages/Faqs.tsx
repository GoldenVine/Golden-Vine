...
export function Faqs() {
  const faqItems = [
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          <p>At Golden Vine, we ensure the highest standards. All our metals are implant-grade or biocompatible, and inert, guaranteeing they are safe to be worn inside the human body. Our gemstones are exclusively either natural and genuine (including sapphires, opals, and diamonds) or lab-made for enhanced strength (such as cubic zirconia and synthetic opals, also known as fauxpals). Furthermore, all our settings are hardware-set, meaning no glues or adhesives ever come into contact with your jewellery. Consequently, the final cost of your piercing will vary significantly based on your chosen piece.</p>
    ...
    {
      id: "wheelchair",
      title: "Is Golden Vine Wheelchair Accessible?",
      content: (
        <p>Yes. Golden Vine is situated on the ground floor and is wheelchair accessible. Our reception and consultation area is an open, wheelchair-accessible space, the front door frame measures 74cm wide with a small step up of perhaps an inch-assistance and ramps can be provided.</p>
      )
    },
    {
      id: "parking",
