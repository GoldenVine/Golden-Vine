...
export function Contact() {
  ...
  const onSubmit = async (values: z.infer<typeof contactSchema>) => {
    if (values.botcheck) return; // honeypot caught a bot
    ...
    try {
      const response = await fetch("https://api.web3forms.com/submit", {
        ...
        body: JSON.stringify({
          access_key: "f9e7957c-f481-4cc0-a137-e551347e74cf",
          ...values
        })
      });
  ...
  return (
    <div className="w-full animate-in fade-in duration-500 pb-12">
      ...
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-10">
        ...
        {/* Left Column: Form */}
        <div className="flex-1 section-cream">
        ...
        <div className="flex-1 section-cream h-fit">
      ...
      {/* Map Section */}
      <section className="max-w-5xl mx-auto mt-12 text-center section-cream">
        ...
        <div className="w-full rounded-xl overflow-hidden shadow-md aspect-video max-h-[450px]">
          <iframe 
            ...
            title="Google Maps Location for Golden Vine Piercing"
          />
        </div>
