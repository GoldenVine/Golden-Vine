      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>Piercing fee:</strong> this is the service charge to safely and expertly perform the piercing you require and varies from <strong>£35-£45</strong> depending on location.</li>
            <li><strong>Decorative choices:</strong> (optional) vary <strong>from £25</strong> to upwards of <strong>£1,000</strong> as many are made from precious metals and gemstones. We have a huge array of styles, designs, colours and shapes suited to all budgets. Pricing is discussed verbally, visually and in writing prior to commitment.</li>
            <li><strong>Sterile saline:</strong> aftercare (suggested but optional) is <strong>£8.50-£12</strong></li>
          </ul>
          ...
          <p><strong>Minimum cost:</strong> most popular piercings made with non-decorative jewellery will likely be <strong>£75-£90</strong> though any and all pricing is finalised verbally, visually and in writing before committing to the total on the day so no shocks or accidental overspends. Figures on this page represent a guide and not a contractual confirmation of amount.</p>
    ...
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <p>For the safety of every piercing we perform, we exclusively fit jewellery purchased directly from our studio at the time of your appointment or downsize. This ensures we can always guarantee the material, fit and quality of everything worn in a fresh or healing piercing.</p>
        </div>
      )
    },
    {
      ...
      content: (
        <div className="space-y-4">
          ...
          <ul className="list-disc pl-6 space-y-2">
            <li><strong>8-16</strong> for lobes ONLY. Both the piercee and a parent/legal guardian must present Photo ID, and the parent/legal guardian must accompany, co-sign and remain present throughout the procedure.</li>
            <li><strong>16-18</strong> for nostril, septum, eyebrow, navel, helix and all other ear piercings not listed above.</li>
            <li><strong>18+</strong> for facial, oral, nipple and genital piercings. Photo ID is still necessary, particularly if you think you look under 25.</li>
          </ul>
        </div>
      )
    },
        ...
        <section className="section-cream max-w-4xl mx-auto py-12 px-6 sm:px-12 text-center">
          ...
          <div className="mt-16 flex justify-center">
            <a 
              ...
              href="https://goldenfern.setmore.com/jess"
              target="_blank" 
              rel="noreferrer"
