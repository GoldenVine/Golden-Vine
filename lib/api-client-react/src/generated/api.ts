...
export const getGetInstagramFeedQueryOptions = <TData = Awaited<ReturnType<typeof getInstagramFeed>>, TError = ErrorType<ErrorResponse>>( options?: { query?:UseQueryOptions<Awaited<ReturnType<typeof getInstagramFeed>>, TError, TData>, request?: SecondParameter<typeof customFetch>}
) => {
...
export type GetInstagramFeedQueryError = ErrorType<ErrorResponse>
...
export function useGetInstagramFeed<TData = Awaited<ReturnType<typeof getInstagramFeed>>, TError = ErrorType<ErrorResponse>>(
